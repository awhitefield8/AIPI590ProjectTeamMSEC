...
# Usage
'''
python src/models/gen_replay_buffer.py --size 20000 --format paper --data ../../data/data_hm/
python src/models/gen_replay_buffer.py --size 20000 --format csv --data ../../data/data_rr/
'''
